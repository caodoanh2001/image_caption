...
path_to_desc = "Flickr8k_text/Flickr8k.token.txt"
...
################################ II. PHẦN ĐỌC ẢNH  ẢNH ############################
dirpath = os.getcwd()
path_to_train_id_file = 'Flickr8k_text/Flickr_8k.trainImages.txt'
path_to_test_id_file = 'Flickr8k_text/Flickr_8k.testImages.txt'
path_to_image_folder = 'Flickr8k_Dataset/Flicker8k_Dataset'
...
# Dự đoán thử 1 ảnh
image_test_id = 10 # Chọn thử anh số 5
